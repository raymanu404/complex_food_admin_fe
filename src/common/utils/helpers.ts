...
import { SUPABASE_PRODUCTS_STORAGE_NAME, SUPABASE_STORAGE_RELATIVE, SUPABASE_URL } from './constants'
...
const createFullPathStorageFile = (fileName:string, storageName = SUPABASE_PRODUCTS_STORAGE_NAME) : string=> [SUPABASE_URL, SUPABASE_STORAGE_RELATIVE, storageName ,fileName].join('/')

export { formatDate, handleImageError, enumToString, stringToEnum, arrayOfProps, arePropsEqual, createFullPathStorageFile }
